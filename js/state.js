...
export const elements = {
  ...
  dynamicModePill: document.getElementById('dynamicModePill'),
  dynamicModeDot: document.getElementById('dynamicModeDot'),
  dynamicModeText: document.getElementById('dynamicModeText'),
